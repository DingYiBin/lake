...
# 选模走 HF config.architectures → registry；默认用仓库内 tiny config + load_format=dummy
export LAKE_MODEL_PATH="${LAKE_MODEL_PATH:-$ROOT/testdata/tiny-qwen3}"
export LAKE_SERVED_MODEL_NAME="${LAKE_SERVED_MODEL_NAME:-tiny-llm}"
